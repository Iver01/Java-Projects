...
//RESET BUTTON
	Action.ResetButton.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			Action.PriceTextField.setText("");			Action.SingleTicketLabel.setSelected(false);
			Action.ReturnTicketLabel.setSelected(false);Action.FirstClassLabel.setSelected(false);
			Action.EconomyLabel.setSelected(false);		Action.StandardLabel.setSelected(false);
			Action.DestinationBox.setSelectedIndex(0);	Action.NumberTicketsBox.setSelectedIndex(0);
			Action.DepartureBox.setSelectedIndex(0);		
		}});
